...
MapGroup_PastaShit:
	map SproutStart, TILESET_FAKE_TOWER, DUNGEON, LANDMARK_UNKNOWN, MUSIC_NONE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map LeaveHall, TILESET_CREEPY_ROOMS, DUNGEON, LANDMARK_UNKNOWN, MUSIC_RUINS_OF_ALPH_RADIO, TRUE, PALETTE_DARK, FISHGROUP_SHORE
	map Graveyard, TILESET_CREEPY_ROOMS, DUNGEON, LANDMARK_UNKNOWN, MUSIC_POKE_FLUTE_CHANNEL, TRUE, PALETTE_DAY, FISHGROUP_SHORE
