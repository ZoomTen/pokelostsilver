...
MapGroup_PastaShit:
	map SproutStart, TILESET_FAKE_TOWER, DUNGEON, LANDMARK_SPROUT_TOWER, MUSIC_NONE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map LeaveHall, TILESET_CREEPY_ROOMS, DUNGEON, LANDMARK_SPROUT_TOWER, MUSIC_RUINS_OF_ALPH_RADIO, TRUE, PALETTE_DAY, FISHGROUP_SHORE
